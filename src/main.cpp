...
{
    int64_t nSubsidy = 1620 * COIN;
	
    if (pindexBest->nHeight == 1)
    {
      nSubsidy = 420000 * COIN; // 2% Free Distribution
...
static const int64_t nTargetTimespan = 5 * 60;  // 16 mins
//
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Honor!";
        CTransaction txNew;
        txNew.nTime = 1401826402;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x3594de307f20fcaf466fc62894e1d0bc44dd3d9453db4f406fc6b56d1136f547"));
        block.print();
